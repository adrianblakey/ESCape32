...
const Cfg cfgdata = {
	...
	.freq_min = FREQ_MIN,       // Minimum PWM frequency (kHz) [48..152]
	.freq_max = FREQ_MAX,       // Maximum PWM frequency (kHz) [48..152]
	...
	.duty_ramp = DUTY_RAMP,     // Maximum duty cycle ramp (kERPM) [0..500]
...
#ifdef TIM1_CCR5
#ifdef IFTIM_BLANK_US
		TIM1_CCR5 = IFTIM_BLANK_US * CLK_MHZ;
#else
